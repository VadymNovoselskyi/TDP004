...
int main()
{
     ...
     cout << "Du skrev in heltalet: " << setw(15)
          << integer << endl;
     cout << "Du skrev in flyttalet: " << setw(14)
          << my_float << endl;
     cin.ignore(9999999999,
                '\n');
     ...
     cout << "Du skrev in heltalet:" << setfill('-') << setw(15) << integer << endl;
     cout << "Du skrev in flyttalet:" << setw(14) << my_float << endl;
     cin.ignore(9999999999, '\n');
