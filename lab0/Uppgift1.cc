...
int main()
{
    ...
    cout << "Du skrev in heltalet: " << setfill(' ') << right << setw(15)
         << integer << endl;
    cout << "Du skrev in flyttalet: " << setfill(' ') << right << setw(14)
         << my_float << endl;
    cin.ignore(9999999999,
               '\n');
    ...
    cout << "Du skrev in \"" << fixed << setprecision(3) << my_float << "\" och \"" << my_string << "\"." << endl;
    cin.ignore(9999999999,
               '\n');
